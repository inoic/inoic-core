...
class Inoic_Instagram_Widget extends WP_Widget {
  ...
  function widget( $args, $instance ) {
    ...
    if ( $username != '' ) {
      ...
      if ( is_wp_error( $media_array ) ) {
        ...
        $linkclass = apply_filters( 'wpiw_link_class', 'clearfix instagram-link' );

        if ( $link != '' ) {
          ?>
                <div class="<?php echo esc_attr( $linkclass ); ?>">
                  <a href="<?php echo trailingslashit( '//instagram.com/' . esc_attr( trim( $username ) ) ); ?>" rel="me" target="<?php echo esc_attr( $target ); ?>"><i class="fa fa-instagram" aria-hidden="true"></i> <?php echo wp_kses_post( $link ); ?></a>
                </div>
          <?php
        }
